...
import org.springframework.boot.i18n.constant.UnicodeConstant;
...
public class LocaleUtils {
    ...
    public static String normalizeToLanguageTag(String localeStr) {
        ...
        if (localeTag.indexOf(UnicodeConstant.ALT) > 0)//handle languages like en-US-alt-short
            localeTag = localeTag.substring(0, localeTag.indexOf(UnicodeConstant.ALT));
